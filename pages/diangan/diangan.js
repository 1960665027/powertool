...
Page({
  data: {
    ...
    items4: [
      { name: 1, value: '棕', checked: 'true', color: "#9a322e" },
      { name: 2, value: '红', color: "#f90100" },
      { name: 0.5, value: '绿', color: "##009900" },
      { name: 0.25, value: '蓝', color: "#060df5" },
      { name: 0.1, value: '紫', color: "#fb99fc" },
      { name: 0.05, value: '灰', color: "#666666" },
      { name: 5, value: '金', color: "#cc9e24" },
      { name: 10, value: '银', color: "#cbcbcb"},
  ...
  radioChange4: function (e) {
   let wucha = e.detail.value;
    ...
    switch (parseFloat(e.detail.value)) {

      case 1:
        console.log('radio发shiyi')
        //绘图
        ctx.setFillStyle("#9a322e")
